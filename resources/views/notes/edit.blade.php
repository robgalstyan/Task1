    ...
    <div class="offset-sm-3 col-sm-6" style="margin-top: 40px">
        <form method="post" action="{{url('/edit_save/'.$edit_note->id)}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="title" value="{{$edit_note->title}}" type="text" class="form-control" id="title">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea name="description" type="text" class="form-control" id="description" rows="5">{{$edit_note->description}}</textarea>
